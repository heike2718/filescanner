...
/**
 * TikaMediaTypeServiceImpl
 */
@ApplicationScoped
public class TikaMediaTypeServiceImpl implements TikaMediaTypeService {

	private static final Logger LOGGER = LoggerFactory.getLogger(TikaMediaTypeServiceImpl.class);
