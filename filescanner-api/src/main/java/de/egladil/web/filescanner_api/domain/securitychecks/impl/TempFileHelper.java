...
public class TempFileHelper {
    ...
    /**
     * Erzeugt ein temporäres File mit suffix '.txt'. Wandelt IOException in
     * SecurityRuntimeException um.
     *
     * @param name String irgendein name
     * @return File
    ...
    /**
     * Erzeugt ein temporäres File. Wandelt IOException in SecurityRuntimeException
     * um.
     *
     * @param name   String irgendein name
    ...
    public static boolean deleteQuietly(final File tempFile) {
        ...
        try {
            ...
            LOGGER
                    .warn("Konnte tempFile nicht löschen: path={}, exception={}", tempFile.getAbsolutePath(),
                            e.getMessage(), e);
            return false;
        }
