...
public class FilescannerResource {
    ...
    public Response hello() {
        ...
        return Response
                .ok(MessagePayload
                        .info("Hallo hier spricht die FilescannerResource der filescanner-api vom Port " + port
    ...
    @GET
    @Path("ping/v1")
    @Operation(operationId = "prüft, ob ClamAV erreichbar ist", summary = "Es wird auf Viren und Zip-Bomben geprüft")
    @APIResponse(name = "PongOKResponse", description = "Quiz erfolgreich geladen", responseCode = "200")
    @APIResponse(
