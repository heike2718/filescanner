...
public class ZipBombScanner {
    ...
    public ThreadDetection checkForZipBomb(final ScanRequestPayload scanRequestPayload) {
        ...
        long compressionRatio = new NonRecursiveZipCompressionRatioComputer()
                .getCompressionRatio(ownerId, upload.getDecodedData());
        ...
        if (compressionRatio >= maxExpectedCompressionRatio) {
            ...
            ZipBombDetected event = new ZipBombDetected()
            ...
            return new ThreadDetection()
                    .withSecurityCheckMessage("Verdacht auf ZIP-Bombe")
                    .withSecurityThreadDetected(true);
        }
