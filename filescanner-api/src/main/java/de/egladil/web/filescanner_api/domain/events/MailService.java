...
public class MailService {
    ...
    public void sendMail(final FilescannerDomainEvent event) {
        ...
        // man kann über quarkus.mailer.mock steuern, ob tatsächlich Mails versendet
        // werden.
        mailer.send(Mail.withText(mailTo, getSubject(new Date()), event.getMessagingPreview()));
