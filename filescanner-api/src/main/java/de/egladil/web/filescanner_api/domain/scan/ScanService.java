...
public class ScanService {
    ...
    /**
     * Unterzieht den gegebenen upoad einer Kette von Tests und gibt ein
     * Gesamtergebnis zurück. Nur wenn die Datei kein Virus ist, wird der MIME-Type
     * ermittelt und davon abhängig weitere gefährliche Dinge wie XMLExpansion,
     * Zip-Bombe,... geprüft. Detections werden als EVENTS gespeichert und per Mail
        ...
        try {
            ...
            if (virusScanResult.isVirusDetected()) {
                ...
                return new ScanResult()
                        .withVirusDetection(virusScanResult)
                        .withUserID(ownerId)
                        .withUploadName(upload.getName());
            ...
            ScanResult result = new ScanResult()
                    ...
                    .withVirusDetection(new VirusDetection());
