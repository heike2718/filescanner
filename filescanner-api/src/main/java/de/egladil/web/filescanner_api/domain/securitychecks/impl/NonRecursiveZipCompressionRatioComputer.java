...
import de.egladil.web.filescanner_api.domain.error.SecurityRuntimeException;

/**
 * NonRecursiveZipCompressionRatioComputer ermittelt die Kompressionsrate aller
 * Dateien in der ersten Ebene eines Zip-Containers. Unterverzeichnisse werden
 * ignoriert.
 */
public class NonRecursiveZipCompressionRatioComputer {
    ...
    /**
     * If it is a ZipFile, this method returns the size of the uncompressed data as
     * sum of the size of uncompressed data in each ZipEntry.
     *
     * @param file
     * @return long
     * @throws IOException
